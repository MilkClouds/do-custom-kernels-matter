...
kernels add a much smaller marginal improvement, and a **correctly configured
`torch.compile` baseline can match or beat the custom-kernel path**. This is a
claim about end-to-end decode/generation attribution, not a claim that custom
kernels are never useful.
